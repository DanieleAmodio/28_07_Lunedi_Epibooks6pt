...
import {
  ...
  CardTitle_default,
  Card_default
} from "./chunk-QRUOOHAF.js";
import "./chunk-3ZJV7LJX.js";
import {
...
var Modal = React50.forwardRef(({
  ...
  const renderBackdrop = (0, import_react27.useCallback)((backdropProps) => (0, import_jsx_runtime49.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React51.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React52.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var PopoverHeader = React53.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React54.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime61.jsxs)(import_jsx_runtime60.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react32.cloneElement)(children, triggerProps), (0, import_jsx_runtime59.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
